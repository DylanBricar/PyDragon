...
class Kamehouse:
    """ Management related to the exterior of the Kamehouse map """
    ...
    def while_kamehouse(self, sound=None):
        ...
        goto_world = tilemap.layers['evenements'].find('exit_gotown')
        ...
        if Niveau.COORDINATES:
            player.player.x = Niveau.COORDINATES[0]
        ...
        while self.while_map_kamehouse:
            ...
            if collide_exit.collision():
                ...
                Niveau.LVL = 'while_map_kamehouse_in'
                Niveau.COORDINATES = [848, 1120]

            collide_goto_world = CollisionController(player, goto_world)
            if collide_goto_world.collision():
                self.while_map_kamehouse = False
                self.while_map_town = True
                Niveau.LVL = 'while_map_town'
                Niveau.COORDINATES = [1205, 1215]
