    ...
    def while_kamehouse(self):
        ...
        while self.while_map_kamehouse:  # Boucle infinie du jeu
            ...
            if collide_exit.collision():  # Si la collision avec la porte a lieu
                ...
                Niveau.COORDONNEE.append(player.player.x)  # Enregistre les dernières coordonnées
                Niveau.COORDONNEE.append(player.player.y+15)  # Modifie les coordonnées pour placer devant la porte
